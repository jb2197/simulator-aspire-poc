...
def get_ins_lst_solid_dispense():  # naoh (2), diketone (0), aldehyde (1)
    ins_list1 = pick_drop_rack_to(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.RACK_REACTANT,
    ...
    ins_list2_2 = solid_dispense(
        ...
        include_dropoff_svvial=True,
        include_dropoff_svtool=True)
    ins_list3 = pick_drop_rack_to(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.RACK_REACTANT,
                                  JUNIOR_BENCHTOP.BALANCE,
                                  JUNIOR_BENCHTOP.SLOT_2_3_2, )
    ins_list4 = pick_drop_rack_to(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.RACK_REACTOR,
...
def get_ins_lst_liquid_dispense():
    # water to naoh
    ins_list7 = needle_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.WATER_VIALS,
                                JUNIOR_BENCHTOP.SLOT_OFF_1,
                                [REACTION_BENCHTOP.quinone_benchtop.NAOH_VIAL, ], JUNIOR_BENCHTOP.SLOT_2_3_2,
                                [1, ])
    # ethanol to diketone
    ins_list8 = needle_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.ETHANOL_VIALS[-1:],
                                JUNIOR_BENCHTOP.SLOT_OFF_1,
                                [REACTION_BENCHTOP.quinone_benchtop.DIKETONE_VIAL, ], JUNIOR_BENCHTOP.SLOT_2_3_2, [1, ])
    # ethanol to aldehyde
    ins_list9 = needle_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.ETHANOL_VIALS[:-1],
                                JUNIOR_BENCHTOP.SLOT_OFF_1,
...
def get_ins_lst_ef():  # quinone (0), grignard (1)
    ins_list1 = pick_drop_rack_to(
        JUNIOR_BENCHTOP, REACTION_BENCHTOP.grignard_benchtop.RACK_REACTANT, JUNIOR_BENCHTOP.SLOT_2_3_2,
        JUNIOR_BENCHTOP.BALANCE
    )
    ins_list2 = solid_dispense(
        junior_benchtop=JUNIOR_BENCHTOP,
        sv_vial=REACTION_BENCHTOP.grignard_benchtop.QUINONE_SVV, sv_vial_slot=JUNIOR_BENCHTOP.SV_VIAL_SLOTS[10],
        dest_vials=[REACTION_BENCHTOP.grignard_benchtop.QUINONE_VIAL, ], amount=0.5, include_pickup_svtool=True,
        include_dropoff_svvial=True, include_dropoff_svtool=True
    )
    ins_list3 = pick_drop_rack_to(JUNIOR_BENCHTOP, REACTION_BENCHTOP.grignard_benchtop.RACK_REACTANT,
                                  JUNIOR_BENCHTOP.BALANCE,
                                  JUNIOR_BENCHTOP.SLOT_2_3_2, )
    ins_list4 = needle_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.grignard_benchtop.THF_VIALS[-1:],
                                JUNIOR_BENCHTOP.SLOT_OFF_2,
...
def get_ins_lst_abcd():
    # a
    ins_list1 = pick_drop_rack_to(JUNIOR_BENCHTOP, REACTION_BENCHTOP.grignard_benchtop.RACK_REACTOR,
                                  JUNIOR_BENCHTOP.SLOT_2_3_1,
                                  JUNIOR_BENCHTOP.BALANCE)
    ins_list2 = solid_dispense(
        junior_benchtop=JUNIOR_BENCHTOP,
...
def get_ins_lst_ghi():
    # g
    ins_listg = pdp_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.grignard_benchtop.QUINONE_VIAL,
                             JUNIOR_BENCHTOP.SLOT_2_3_2,
                             REACTION_BENCHTOP.grignard_benchtop.PDP_TIPS[
                             len(REACTION_BENCHTOP.grignard_benchtop.REACTOR_VIALS):],
                             JUNIOR_BENCHTOP.SLOT_2_3_3, REACTION_BENCHTOP.grignard_benchtop.REACTOR_VIALS,
                             JUNIOR_BENCHTOP.SLOT_2_3_1, 0.04)
...
def define_instructions():
    ...
    ins_lst_diketone_sln_dispense = pdp_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.DIKETONE_VIAL,
                                                 JUNIOR_BENCHTOP.SLOT_2_3_2,
                                                 REACTION_BENCHTOP.quinone_benchtop.PDP_TIPS[
                                                 : len(REACTION_BENCHTOP.quinone_benchtop.REACTOR_VIALS)],
                                                 JUNIOR_BENCHTOP.SLOT_2_3_3,
    ...
    ins_lst_naoh_sln_dispense = pdp_dispense(JUNIOR_BENCHTOP, REACTION_BENCHTOP.quinone_benchtop.NAOH_VIAL,
                                             JUNIOR_BENCHTOP.SLOT_2_3_2,
                                             REACTION_BENCHTOP.quinone_benchtop.PDP_TIPS[
                                             len(REACTION_BENCHTOP.quinone_benchtop.REACTOR_VIALS):],
                                             JUNIOR_BENCHTOP.SLOT_2_3_3,
